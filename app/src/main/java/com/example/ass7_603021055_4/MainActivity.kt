package com.example.ass7_603021055_4
...
class MainActivity : AppCompatActivity() {
    ...
    private fun  testEmployeeDate() {
        EmployeeList.add(Employee("Bongkod" ,"Female", "bongkodwan_n@kkumail.com" ,60000))
        EmployeeList.add(Employee("Jaemin" ,"Male", "Najaemin1308@gmail.com" ,100000))
    }
}